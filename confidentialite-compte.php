...
<body class="lfdj-maincontainer">
  ...
  <div class="lfdj-bloc-text">
    ...
    <ul class="lfdj-privacy-list">
      ...
      <li>
        <strong>Via le formulaire « Mon compte »</strong> : pseudo affiché et statut associatif (obligatoires) ;
        rang / titre imaginaire, âge, ville, année d’adhésion (« Depuis ? »), liste de jeux (5 au plus sur la fiche publique, éventuellement avec emojis),
        et jusqu’à trois liens ou pseudos de réseaux sociaux avec type de réseau (site web, Instagram, Facebook, Twitter/X, ArtStation) — ces derniers champs étant facultatifs.
      </li>
      <li>
        <strong>Photo d’illustration (facultative)</strong> : si vous en envoyez une, elle est enregistrée sur les serveurs du site
        (fichier image dérivé, format carré, distinct de l’avatar Discord) et peut être affichée à la place de ce dernier sur certaines pages.
      </li>
    </ul>
